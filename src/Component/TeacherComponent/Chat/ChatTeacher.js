import './Chat.css'
import ChatWithUser from '../ChatWithTeacher/ChatWithUser.js'
...
function ChatTeacher() {
    ...
    const userId = localStorage.key("userId") ? localStorage.getItem("userId") : ""
    ...
    return (
        <div className='chat_container'>
            <div className='chat'>
                ...
                <div className='chat_body'>
                    {message && message.map(item => {
                        return (
                            <div key={item.id} className={item.userId ? 'chat_body-item left-mes' : 'chat_body-item right-mes'}>{item.detail}</div>
                        )
                    })}
            ...
            <ChatWithUser setNumber={setNumber} />
        </div>
    )
}
